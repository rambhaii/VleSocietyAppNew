    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Obx(() =>loginController.rxPath.value.isEmpty?   Container(
                    ...
                    child: Column(
                      ...
                      [
                       ...
                       //     Get.to(()=>youtube());
                          ...
                          contentPadding: EdgeInsets.only(left: 20,right: 20),
                          title: Text("YOUTUBE",  style: titleStyle.copyWith(
                              fontWeight: FontWeight.w800,
                              fontSize: 19,height:.3
                        ...
                        ListTile(
                          ...
                          contentPadding: EdgeInsets.only(left: 20,right: 20),
                          title: Text("CERTIFICATES", style: titleStyle.copyWith(
                              fontWeight: FontWeight.w800,
                              fontSize: 19,height:.3
                        ...
                        ListTile(
                          ...
                          contentPadding: EdgeInsets.only(left: 20,right: 20),
                          title: Text("ABOUT CSC",  style: titleStyle.copyWith(
                              fontWeight: FontWeight.w800,
                              fontSize: 19,height:.3
                          )),
                        ),
                       ...
                       onTap: (){
                          ...
                          contentPadding: EdgeInsets.only(left: 20,right: 20),
                          title: Text("AWARDS", style: titleStyle.copyWith(
                              fontWeight: FontWeight.w800,
                              fontSize: 19,height:.3
                        ...
                        ListTile(
                          ...
                          contentPadding: EdgeInsets.only(left: 20,right: 20),
                          title: Text("TESTIMONIALS", style: titleStyle.copyWith(
                              fontWeight: FontWeight.w800,
                              fontSize: 19,height:.3
                            ...
                            Column(
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: Image.asset('assets/images/ratus.png',
                                    fit: BoxFit.cover,width: 40,height: 40,),
                                ),
                                SizedBox(height: 10),
                          ...
                          Column(
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    child: Image.asset('assets/images/shar.png',
                                      fit: BoxFit.cover,width: 40,height: 40,),
                                  ),
                                  SizedBox(height: 10),
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text("TERM OF USE\nPRIVACY & POLICY", style: smallTextStyle.copyWith(color:Colors.cyan,height: 1.6),textAlign: TextAlign.center,),
                            ],
                          ),
                        ),
                        SizedBox(height: 15,),
                        RawMaterialButton(
                          constraints: BoxConstraints(maxHeight: 43, minWidth: 43),
                          onPressed: () {showAlertBox();},
                          shape: CircleBorder(),
                          child:CircleAvatar(
                            backgroundColor: Colors.red.withOpacity(0.05),
                            backgroundImage: AssetImage("assets/images/logoutlogo.png"),)
                                  ),
                        SizedBox(height: 6,),
                        Text("SIGN OUT",style: bodyText1Style.copyWith(color: Colors.red,fontSize: 13)
                        ),
                      ],
                    ) )),
            /* Positioned(
                                      ...
                                      children: [
                                        CircularButton(
                                          onPress: () {
                                            ...
                                            controller.postAppFeedbackNetworkApi(
                                                etmessage.text,"");
                                            Get.back();
                                            //Get.back();
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                [
                                  Padding(padding: EdgeInsets.only(left: 60)),
                                  Text("Profile",style:playfairDisplay.copyWith(fontWeight: FontWeight.w800) ,),
                                ],
                              ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(controller.userName.toString(), style: titleStyle.copyWith(fontSize: 17,
                                            fontWeight: FontWeight.w800)),
                                        SizedBox(height: 4,),
                                        Text("",style:subtitleStyle,overflow: TextOverflow.ellipsis,maxLines: 2,),
                                      ],
                                    ),
                                  ),
                                ],
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Padding(padding: EdgeInsets.only(left: 80),
                                        child: Center(
                                          child:  EditTextWidget(controller: loginController.etName, hint: 'Name',
                                            validator: (value){
                                    ...
                                    Padding(padding: EdgeInsets.only(left: 80),
                                        child: Center(
                                          child:  EditTextWidget(controller: loginController.etEmail, hint: 'Email',
                                    ...
                                    Padding(padding: EdgeInsets.only(left: 80),
                                        child: Center(
                                          child:  EditTextWidget(controller: loginController.etMobile, hint: 'Mobile',
                                            validator: (value){
                                              if(value.toString().isEmpty)
                                              {
                                        ...
                                        child: Center(
                                          ...
                                          return  loginController.stateData.value.data !=
                                              ...
                                              onChanged: (newValue) {
                                                ...
                                                loginController.selectedState
                                                    .stateId!;
                                                loginController.stateData.refresh();
                                                loginController.cityModel.value
                                                    .data = null;
                                    ...
                                    Padding(padding: EdgeInsets.only(left: 80),
                                        child: Center(
                                          child: Obx(() {
                                            if(loginController.cityModel.value.data!=null)
                                              {
                                                int ind = loginController.cityModel.value.data!.indexWhere((element) => element.id == GetStorage().read(AppConstant.cityId).toString());

                                                if (ind != -1) {
                                                  loginController.selectedCity = loginController.cityModel.value.data![ind];
                                                  loginController.etCity.text=loginController.cityModel.value.data![ind].id!;
                                                }
                                              }

                                            return loginController.cityModel
                                                .value.data !=
                                                null ? DropdownButton(
                                              ...
                                              icon: const Icon(Icons
                                                  .keyboard_arrow_down),
                                              items: loginController.cityModel
                                                  .value.data!.map((
                                                  CityDatum items) {
                                                return DropdownMenuItem(
                                                  value: items,
                      ...
                      child: Container(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text("Interest",style:playfairDisplay.copyWith(fontSize: 33,
                                        fontWeight: FontWeight.bold),),
                                  ],
                                ),
                                GridView.count(
            ...
            Row(
              children: [
                ...
                Stack(
                  children: [
                    ...
                    Positioned(
                       right: 0,
                        bottom: 5,
                        child:widget.choice!.isSelected==true?Container(
                          height: 15,
                          width: 15,
                          decoration: BoxDecoration(
                            color: Colors.green,
                ...
                Column(
                  ...
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    Text(widget.choice!.title!, style: titleStyle.copyWith(fontSize: 10,
                        fontWeight: FontWeight.w800)),],
                ),
